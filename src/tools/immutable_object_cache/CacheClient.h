...
public:
  ...
  void lookup_object(std::string pool_name, std::string object_id, Context* on_finish, bufferlist* bl=nullptr);
  void send_message();
  void try_send();
...
private:
  ...
  ClientProcessMsg m_client_process_msg; // TODO replace it.
